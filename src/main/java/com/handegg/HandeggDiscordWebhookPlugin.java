...
public class HandeggDiscordWebhookPlugin extends Plugin
{
	...
	{
		log.info("Handegg Discord Webhook started!");
	}

	@Override
	protected void shutDown() throws Exception
	{
		log.info("Handegg Discord Webhook stopped!");
	}
	...
	public void onGameStateChanged(GameStateChanged gameStateChanged)
	{
		...
		{
			client.addChatMessage(ChatMessageType.GAMEMESSAGE, "", "Handegg Discord Webhook says " + config.greeting(), null);
		}
	}
